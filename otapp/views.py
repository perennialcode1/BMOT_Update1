...
#@session_required
def surgeon_case_edit(request, id, hid):
    data, surgeon_name_dropdown_data, surgeon_dropdown_data, speciality_dropdown_data = surgeon_case_details_edit(request, id, hid)
    context={
        'data': data,
        'surgeon_name_dropdown_data': surgeon_name_dropdown_data,
        'surgeon_dropdown_data': surgeon_dropdown_data,
        'speciality_dropdown_data': speciality_dropdown_data,
    }
    return render(request, 'surgeries/surgeon-case-edit.html', context)

#@session_required
def surgeries_edit_btn(request, id):
    data, surgeon_dropdown_data, speciality_dropdown_data, surgeon_name_dropdown_data = surgery_details_edit(request, id)
    context = {
        'data': data,
        'surgeon_dropdown_data': surgeon_dropdown_data,
        'speciality_dropdown_data': speciality_dropdown_data,
    ...
    return render(request, 'surgeries/surgery-details-edit.html', context)
...
def config_speciality_list(request):
    data = config_speciality_get(request)
    if request.method == 'POST':
        data = config_speciality_get(request)
        context = {
            'data' : data,
...
def config_edit_speciality(request):
    config_post_specialist(request)
